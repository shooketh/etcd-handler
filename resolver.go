...
func (b builder) Build(target gresolver.Target, cc gresolver.ClientConn, opts gresolver.BuildOptions) (gresolver.Resolver, error) {
	...
	r.ctx, r.cancel = context.WithCancel(b.ctx)
...
// Add ctx context.Context to the original source code.
func NewBuilder(ctx context.Context, client *clientv3.Client) (gresolver.Builder, error) {
	return builder{c: client, ctx: ctx}, nil
}
